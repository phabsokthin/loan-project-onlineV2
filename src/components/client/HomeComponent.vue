        ...
        <section>
            ...
            <div>
                <div class="max-w-4xl px-6 mx-auto text-white">
                    <div class="relative p-2 overflow-hidden bg-gray-800 border rounded-md opacity-45 md:px-8 group ">
                        <div class="relative flex items-center justify-between gap-2">
                            <div class="flex items-center gap-5">
                                ...
                                <div>
                                    <p class="mt-1 font-sm bold text-">
                            ...
                            <div v-if="user">
                                <div v-for="usDoc in userDoc" :key="usDoc"
                                    ...
                                    <div 
                                        class="space-y-3 ">
                                        <h1 class="font-bold text-white text-md">{{ formatCurrency(usDoc.loanAmount) }}</h1>
                                    </div> 
...
export default {
    setup() {
        ...
        return { user, handleRequestLoan, userDoc, handleLoanInformationNext,formatCurrency }
    }
}
