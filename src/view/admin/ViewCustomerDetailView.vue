                        ...
                        <div class="mt-4 space-y-4">
                            <div class="relative flex items-start">
                                ...
                                <div class="ml-3 text-sm">
                                    <img :src="usDoc?.front_image" class="object-contain w-full p-2 bg-white border h-52"
                                        alt="">
                                </div>
                            </div>
                    ...
                    <fieldset class="mt-6">
                        ...
                        <div class="mt-4 space-y-4">
                            <div class="relative flex items-start">
                                ...
                                <div class="ml-3 text-sm">
                                    <img :src="usDoc?.selfie_image" class="object-contain w-full p-2 bg-white border h-52"
                                        alt="">
                                </div>
                            </div>
                        </div>
                ...
                <div class="p-4 mt-6 text-white bg-blue-600 rounded-md shadow-xl">
                    <div class="space-y-3">
                        ...
                        <h1 class="flex justify-between font-mono text-xl">Status:
                            ...
                            <span v-else class="p-2 font-mono text-sm bg-green-500 rounded-full">
