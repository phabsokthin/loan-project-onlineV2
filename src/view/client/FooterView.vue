<template>
    <footer
        class='flex flex-col justify-between py-[6%] px-[4%]  text-white text-center p-4 w-full h-auto relative bg-[oklch(58.8%_0.158_241.966)] opacity-80  shadow-sm border '>
