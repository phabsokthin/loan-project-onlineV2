<template>
  <div>
    ...
    <!-- Main Container -->
    <div class="min-h-screen px-4 py-4 m-auto hero-image" v-motion-fade >
      <div class="w-full max-w-5xl mx-auto mt-10">
        ...
        <h2 class="flex items-center gap-2 p-3 text-lg font-semibold text-white bg-black rounded-t-md">
          <!-- Back Arrow Icon -->
         <router-link :to="{name:'home'}" class="text-white hover:text-gray-200"> <svg
            class="w-6 h-6"
        ...
        <div class="relative mt-5 overflow-hidden rounded-md">
          <div
            class="relative p-6 text-white rounded-md shadow-md bg-black/50"
          >
            <!-- Icon Top Left -->
        ...
        <div class="relative mt-5 overflow-hidden rounded-md">
          <div class="relative p-4 text-white rounded-md bg-black/50">
            ...
            <div class="flex justify-between">
              ...
              <span class="font-semibold text-green-400">Approved</span>
            </div>
          </div>
        </div>
