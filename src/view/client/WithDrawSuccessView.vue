<template>
    ...
    <div class="flex flex-col justify-start items-center bg-gray-50/30 min-h-[100vh]">
        ...
        <div class="mx-auto flex w-full  flex-col justify-center px-5 pt-0 md:h-[unset] max-w-[520px] lg:px-6 xl:pl-0">
            <div class="relative flex w-full flex-col pt-[20px] md:pt-0">
                <div
                    class="max-w-full px-6 pt-8 pb-6 mb-5 mr-0 border rounded-lg shadow-sm bg-card text-card-foreground h-min dark:border-zinc-800 md:mb-0">
                    <div class="relative mx-auto flex w-full max-w-full md:pt-[unset] mb-6">
                        ...
                        <div>
                            <p class="mb-1 font-medium text-zinc-950 dark:text-white">
                    ...
                    <div class="relative mx-auto flex w-full max-w-full md:pt-[unset]">
                        <div class="w-2 h-2 mt-1 bg-gray-500 rounded-full me-4"></div>
                        <div>
